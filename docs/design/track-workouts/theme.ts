import { createTheme, rem, Button, Card, Title, Badge, type MantineColorsTuple } from '@mantine/core';
 ...
 * Шрифты подключаются в index.html: Commissioner (текст) + Oswald (дисплей).
 */
...
export const theme = createTheme({
	...
	fontFamily:
		'Commissioner, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica, Arial, sans-serif',
	fontFamilyMonospace: 'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace',

	headings: {
		fontFamily: 'Oswald, Commissioner, sans-serif',
		fontWeight: '600',
		sizes: {
